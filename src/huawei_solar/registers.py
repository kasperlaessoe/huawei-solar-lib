...
GRIDFLOW_REGISTERS = {
    rn.ENERGY_STORAGE_FORCIBLE_CHARGE_POWER: U32Register("kW", 1, 47247, writeable=True),
    rn.ENERGY_STORAGE_FORCIBLE_DISCHARGE_POWER: U32Register("kW", 1, 47249, writeable=True),
}

REGISTERS.update(GRIDFLOW_REGISTERS)
